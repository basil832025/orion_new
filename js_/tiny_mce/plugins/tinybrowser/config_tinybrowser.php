...
$tinybrowser['obfuscate'] = 'asdsna892njnasjk81';
...
$tinybrowser['docroot'] = DIR_ROOT;

// Folder permissions for Unix servers only
$tinybrowser['unixpermissions'] = 0777;

// File upload paths (set to absolute by default)
$tinybrowser['path']['image'] = DIR_IMAGES_;//'/uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = DIR_MEDIA_;//'/uploads/media/'; // Media files location
$tinybrowser['path']['file'] =DIR_FILES_; //'/uploads/files/'; // Other files location
