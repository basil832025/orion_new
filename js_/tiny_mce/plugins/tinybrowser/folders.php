...
$dirs=array();
dirtree($dirs,$tinybrowser['docroot'],$tinybrowser['path'][$typenow]);
...
<?php
if($tinybrowser['allowupload']) echo '<li id="upload_tab"><span><a href="upload.php?type='. $typenow.$passfolder.$passfeid .'">'. TB_UPLOAD .'</a></span></li>';
if($tinybrowser['allowfolders']) echo '<li id="edit_tab"><span><a href="edit.php?type='. $typenow.$passfolder.$passfeid .'">'. TB_EDIT .'</a></span></li>';
