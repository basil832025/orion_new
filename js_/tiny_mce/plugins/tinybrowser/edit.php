...
// Set language
if(isset($tinybrowser['language']) && file_exists('langs/'.$tinybrowser['language'].'.php')) require_once('langs/'.$tinybrowser['language'].'.php'); 
else require_once('langs/en.php'); // Falls back to English
...
while (false!==($filename=readdir($dh))) {
	if(is_file($tinybrowser['docroot'].$editpath.$filename)) {
...
<?
if($passfeid == '' && $tinybrowser['integration']=='tinymce') echo '<link rel="stylesheet" type="text/css" media="all" href="'.$tinybrowser['tinymcecss'].'" />';
else echo '<link rel="stylesheet" type="text/css" media="all" href="css/stylefull_tinybrowser.css" />';
?>
...
<ul>
	...
	<?php if($tinybrowser['allowupload']) { ?><li id="upload_tab"><span><a href="upload.php?type=<?php echo $typenow.$passfolder.$passfeid ; ?>"><?php echo TB_UPLOAD; ?></a></span></li><?php } ?>
	<li id="edit_tab" class="current"><span><a href="edit.php?type=<?php echo $typenow.$passfolder.$passfeid ; ?>"><?php echo TB_EDIT; ?></a></span></li>
	<?php if($tinybrowser['allowfolders']) { ?><li id="folders_tab"><span><a href="folders.php?type=<?php echo $typenow.$passfolder.$passfeid; ?>"><?php echo TB_FOLDERS; ?></a></span></li><?php }
...
<?php form_open('edit','custom',basename($_SERVER['SCRIPT_NAME']),'?type='.$typenow.$passfolder.$passfeid); ?>
<div class="pushleft">
<?php
