...
<?php
if($passfeid == '' && $tinybrowser['integration']=='tinymce') { ?><link rel="stylesheet" type="text/css" media="all" href="<?php echo $tinybrowser['tinymcecss']; ?>" /><?php }
...
function uploadComplete(url) { document.location = url; }
